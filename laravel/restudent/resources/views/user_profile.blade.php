                ...
                <form action="{{url('/update_basic_info')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="phone" class="form-control shadow-none" value="{{$data->phone}}">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="text-center">
                            <button class="btn shasow-none">SUBMIT</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <form action="javascript:void(0)" method="post" id="update_password_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="password" name="c_password" class="form-control shadow-none" id="up_dt_cpas">
                        </div>
